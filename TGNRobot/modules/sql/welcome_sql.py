...
DEFAULT_WELCOME_MESSAGES = [
    ...
    "{first} просто присоединился. Могу я вылечиться?",
    "{first} just joined the chat - asdgfhak!",
    "{first} just joined. Everyone, look busy!",
    "Welcome, {first}. Подожди и послушай.",
    "Welcome, {first}. Мы ждали тебя ( ͡° ͜ʖ ͡°)",
    "Welcome, {first}. Надеемся, вы принесли пиццу.",
    "Welcome, {first}. Оставьте свое оружие у двери.",
    "Swoooosh. {first} just landed.",
    "Приготовьтесь. {first} только что присоединился к чату.",
    "{first} просто присоединился. Спрячьте свои бананы.",
    "{first} просто скользнул в чат.",
    "A {first} появился в чате.",
    "Жирный {first} появился!",
    "Где {first}? В чате!",
    "{first} прыгнул в чат. Кенгуру!!",
    "{first} Кто ты? Знаю, знаю — ты никто.",
    "{first} Помолчи — за умного сойдешь",
    "Это птица! Это самолет! Неважно, это просто {first}.",
    "Ха! {first} присоединился! Вы активировали мою ловушку!",
    "Мы ждали тебя  {first}",
    "{first} тебе следует пойти в зоопарк,ты там не особо будешь выделяться",
    "{first} Я так рад вас видеть! Понимаете, я коллекционирую уродов. И вдруг, такой редкий экземпляр...!",
